...
1. After installing the **AWS Toolkit** and configuring your AWS account, Visual Studio Code will display a list of AWS services available in the selected region (**Asia Pacific - Singapore**).After installing the **AWS Toolkit** and configuring your AWS account, Visual Studio Code will display a list of AWS services available in the selected region (**Asia Pacific - Singapore**).

![Connect](/images/3.connect/01-3.1-connectAWSAccount.png)
...
![Connect](/images/3.connect/02-3.1-setupenv.png)
...
![Connect](/images/3.connect/03-3.1-setting.png)
